...
class StGraphDeciderTest : public testing::Test {
 public:
  virtual void SetUp() {
    LoadPlanningConfig();
    LoadTaskConfig();
...
TEST_F(StGraphDeciderTest, Process) {
  StGraphDecider st_graph_decider(task_config_, internal_);
  bool ret = st_graph_decider.Process(&reference_line_info_, &frame_);
