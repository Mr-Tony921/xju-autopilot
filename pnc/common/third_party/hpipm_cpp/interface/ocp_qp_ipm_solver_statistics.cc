...
void OcpQpIpmSolverStatistics::resize(const size_t size) {
  obj_val = std::numeric_limits<double>::infinity();
...
std::string OcpQpIpmSolverStatistics::info() const {
  return absl::StrCat("===== Hpipm Solver Statistics =====", "\n",
                      "obj velue:    ", obj_val, "\n",
                      "ipm iter:     ", iter, "\n",
                      "max_res_stat: ", max_res_stat, "\n",
                      "max_res_eq:   ", max_res_eq, "\n",
                      "max_res_ineq: ", max_res_ineq, "\n",
                      "max_res_comp: ", max_res_comp);
}
